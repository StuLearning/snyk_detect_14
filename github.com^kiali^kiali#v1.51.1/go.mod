module github.com/kiali/kiali-v1.51.1

go 1.17

require github.com/kiali/kiali v1.51.1
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/gorilla/mux/otelmux v0.27.0 // indirect
	...
	istio.io/client-go v1.13.2 // indirect
