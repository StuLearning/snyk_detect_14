module github.com/kiali/kiali-v1.26.0

go 1.17

require github.com/kiali/kiali v1.26.0
...
require (
	...
	github.com/kiali/k-charted v0.6.3 // indirect
	...
	k8s.io/client-go v11.0.1-0.20190820062731-7e43eff7c80a+incompatible // indirect
